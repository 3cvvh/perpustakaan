                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-orange-100">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <a href="hapus_buku.php?id=<?php echo $u["BukuID"] ?>" class="text-red-500 hover:underline" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');">Hapus</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
